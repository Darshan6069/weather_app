...
import 'package:weather_app/setting_screeen.dart';
                    ...
                    child: Column(
                        children: [
                          ...
                          (proVar.getTemp == false)? Text(
                            ...
                            '${weather!.current!.windKph}°/ ${weather!.current!.feelslikeF}° Feels like ${weather!.current!.feelslikeF}°',
                            style: TextStyle(
                              fontWeight: FontWeight.w500,
                              fontSize: 19,
                            ),
